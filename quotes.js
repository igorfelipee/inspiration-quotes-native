export default [
    ...
    {
        quote:
            'Não deixe que o medo de perder seja maior que a excitação de vencer.',
    ...
    {
        quote:
            'Dificuldades reais podem ser superadas; apenas as imaginárias são insuperáveis.',
        author: 'Theodore N. Vail',
    },
    { quote: 'A fortuna fica ao lado daquele que ousa.', author: 'Virgil' },
    {
        quote:
    ...
    {
        quote:
            'Pessoas raramente obtém sucesso a menos que se divirtam com o que fazem.',
    ...
    {
        quote:
            'Há dois tipos de pessoas que dirão que você não pode fazer diferença nesse mundo: aquelas que tem medo de tentar e aquelas que temem que você consiga.',
        author: 'Ray Goforth',
    },
    {
        quote:
    ...
    {
        quote:
            'Pessoas bem sucedidas fazer o que pessoas não mal-sucedidas não estão dispostas a fazer. Não desejam que seja mais fácil, mas que sejam melhores.',
        author: 'Jim Rohn',
    },
    {
        quote:
    ...
    {
        quote:
            'Pegue uma ideia. Faça dessa única ideia a sua vida - pense nela, sonhe com ela, viva essa ideia. Deixe o cérebro, os músculos, os nervos, todas as partes do seu corpo, estarem cheios dessa ideia, e apenas deixe todas as outras ideias em paz. Este é o caminho para o sucesso.',
        author: 'Swami Vivekananda',
    },
    {
        quote:
            'A razão número um para as pessoas que falham na vida é porque ouvem seus amigos, família e vizinhos.',
    ...
    {
        quote:
            'Boas coisas vem para as pessoas que esperam, mas coisas ainda melhores vêm para aquelas que vão e buscam.',
        author: 'Anonymous',
    },
    {
        quote:
    ...
    {
        quote:
            'O sucesso é ... conhecer o seu propósito na vida, crescer para alcançar o seu potencial máximo e semear as sementes que beneficiam os outros.',
    ...
    {
        quote:
            'Empresários de sucesso são doadores e não tomadores de energia positiva.',
        author: 'Anonymous',
    },
    {
        quote:
    ...
    {
        quote:
            'Nosso maior medo não deve ser o fracasso, mas o sucesso nas coisas da vida que realmente não importam.',
        author: 'Francis Chan',
    },
    {
        quote:
            'Você mede o tamanho da conquista pelos obstáculos que você teve que superar para alcançar seus objetivos.',
    ...
    {
        quote:
            'Seja miserável ou se motive. O que quer que tenha que ser feito, é sempre sua escolha.',
        author: 'Wayne Dyer',
    },
    {
        quote:
            'Quando você pára de perseguir as coisas erradas, você dá as coisas certas a chance de pegar você.',
        author: 'Lolly Daskal',
    },
    {
        quote:
    ...
    {
        quote:
            'Para ser bem sucedido, você deve aceitar todos os desafios que surgem em seu caminho. Você não pode simplesmente aceitar os que você gosta.',
        author: 'Mike Gafka',
    },
    {
        quote:
            'Se você não valoriza seu tempo, nem os outros irão. Pare de doar seu tempo e talentos - comece a cobrar por isso.',
        author: 'Kim Garst',
    },
    {
        quote:
    ...
    {
        quote:
            'A felicidade é uma borboleta que, quando perseguida, está sempre além de seu alcance, mas que, se você se sentar em silêncio, pode pousar em você.',
        author: 'Nathaniel Hawthorne',
    },
    {
        quote:
            'Eu acho que quando você tem um interesse real na vida e uma vida curiosa, esse sono não é a coisa mais importante.',
        author: 'Martha Stewart ',
    },
    {
        quote:
            'Só adie para amanhã o que você esta disposto a morrer tendo deixado desfeito.',
    ...
    {
        quote:
            'Se você não conceber o seu próprio plano de vida, é provável que caia no plano de outra pessoa. E adivinha o que eles planejaram para você? Não muito.',
        author: ' Jim Rohn',
    },
    {
        quote:
    ...
    {
        quote:
            'Confie porque você está disposto a aceitar o risco, não porque é seguro ou certo.',
        author: 'Anonymous',
    },
    {
    ...
    {
        quote:
            'Se você realmente quer algo, não espere - se ensine a ser impaciente.',
        author: 'Gurbaksh Chahal',
    },
    {
        quote:
            'Se você fizer o que você sempre fez, você terá o que sempre conseguiu.',
        author: 'Anonymous',
    },
    {
        quote:
    ...
    {
        quote:
            'Pessoas que conseguem ter sucesso. Quanto mais eles têm sucesso, mais eles querem ter sucesso, e mais eles encontram um caminho para ter sucesso. Da mesma forma, quando alguém está falhando, a tendência é entrar em uma espiral descendente que pode até se tornar uma profecia auto-realizável.',
        author: 'Tony Robbins',
    },
    {
        quote:
            'Pequenas mentes são domadas e subjugadas pelo infortúnio; mas grandes mentes se erguem acima dela.',
    ...
    {
        quote:
            'Qual é o ponto de estar vivo se você não tentar fazer algo notável?.',
        author: 'Anonymous',
    },
    {
        quote:
    ...
    {
        quote:
            'A razão pela qual a maioria das pessoas nunca alcança seus objetivos é que eles não os definem, nem os consideram seriamente como críveis ou viáveis. Os vencedores podem dizer para onde estão indo, o que planejam fazer no caminho e quem compartilhará a aventura com eles.',
    ...
    {
        quote:
            'A maioria das coisas importantes no mundo foi realizada por pessoas que continuaram tentando quando parecia não haver ajuda.',
        author: 'Dale Carnegie',
    },
    {
    ...
    {
        quote:
            'A melhor razão para começar uma organização é fazer sentido; para criar um produto ou serviço para tornar o mundo um lugar melhor.',
        author: 'Guy Kawasaki',
    },
    {
    ...
    {
        quote:
            'Sempre que você vê uma pessoa de sucesso, você só vê as glórias públicas, nunca os sacrifícios privados para alcançá-los..',
        author: 'Vaibhav Shah',
    },
    {
        quote:
            'Nós nos tornamos o que pensamos a maior parte do tempo, e esse é o segredo mais estranho.',
    ...
    { quote: 'A disciplina é a mãe do êxito.', author: 'Ésquilo' },
    {
        quote:
    ...
    { quote: 'Não é possível ser bom pela metade.', author: 'Léon Tolstoi' },
    {
        quote:
    ...
    { quote: 'É capaz quem pensa que é capaz.', author: 'Buda' },
    { quote: 'O ser capaz mora perto da necessidade.', author: 'Pitágoras' },
    {
        quote:
    ...
    { quote: 'O sucesso e o amor preferem o corajoso.', author: 'Ovídio' },
    {
        quote:
    ...
    {
        quote:
            'Sucesso é saber a diferença entre perseguir as pessoas e fazer com que as pessoas fiquem do seu lado.',
        author: 'Desconhecido',
    },
    {
        quote:
            'Um dos segredos do sucesso é se recusar a deixar que reveses temporários nos derrotem.',
        author: 'Mary Kay',
    },
    {
    ...
    { quote: 'A disciplina é a mãe do sucesso.', author: 'Ésquilo' },
    {
        quote:
    ...
    { quote: 'Coragem é manter a classe sob pressão.', author: 'John Kennedy' },
    {
